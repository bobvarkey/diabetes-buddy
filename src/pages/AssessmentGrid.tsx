...
const TOOLS = [
  ...
  { id: 2, name: 'Insulin Titration', category: 'Dosing', pro: false, color: 'bg-neon-cyan', route: '/insulin-titration' },
  { id: 3, name: 'HbA1c Tracker', category: 'Monitoring', pro: false, color: 'bg-neon-pink', route: '/progress' },
  { id: 4, name: 'GLP-1 Administration', category: 'Dosing', pro: false, color: 'bg-neon-lime', route: '/glp1-administration' },
  { id: 5, name: 'Plate Method', category: 'Nutrition', pro: false, color: 'bg-neon-orange', route: '/plate' },
  { id: 6, name: 'Diet Plan', category: 'Diet', pro: false, color: 'bg-neon-violet', route: '/diet-plan' },
  { id: 7, name: 'Hypo Risk Score', category: 'Safety', pro: false, color: 'bg-neon-red', route: '/hypo-risk' },
  { id: 8, name: 'Sliding Scale Insulin', category: 'Dosing', pro: false, color: 'bg-neon-yellow', route: '/sliding-scale' },
  { id: 9, name: 'Food Database', category: 'Nutrition', pro: false, color: 'bg-neon-magenta', route: '/foods' },
  { id: 10, name: 'Renal Dosing', category: 'Safety', pro: false, color: 'bg-neon-cyan', route: '/renal-dosing' },
  { id: 11, name: 'Prediabetes Guide', category: 'Education', pro: false, color: 'bg-neon-pink', route: '/prediabetes' },
  { id: 12, name: 'CKD Guidelines', category: 'Comorbidity', pro: false, color: 'bg-neon-lime', route: '/ckd-guideline' },
